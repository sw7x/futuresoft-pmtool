                                        ...
                                        <div class="panel-body">                                    
                                            ...
                                            <form class="pm-create-form" id="" action="" method="post">
                                                ...
                                                <div class="form-group  row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="pm_fname" class="form-control" required value="{{ old('pm_fname') }}" placeholder="Enter your first name">
                                                        @if ($errors->has('pm_fname'))
                                                            <ul class="mt-1">
                                                                @foreach ($errors->get('pm_fname') as $error)
                                                ...
                                                <div class="form-group  row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="pm_lname" class="form-control" required value="{{ old('pm_lname') }}" placeholder="Enter your last name">
                                                        @if ($errors->has('pm_lname'))
                                                            <ul class="mt-1">
                                                                @foreach ($errors->get('pm_lname') as $error)
                                                                    <li class="text-red-600 text-xs font-bold">{{ $error }}</li>
                                                                @endforeach
                                                            </ul>
                                                        @endif
                                                ...
                                                <div class="form-group  row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="qemail" name="pm_email" class="form-control" required value="{{ old('pm_email') }}" placeholder="your@email.com">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8 input-group date">
                                                        ...
                                                        <input type="text" class="form-control" name="pm_date_of_birth" value="{{ old('pm_date_of_birth') }}" placeholder="mm / dd / yyyy">
                                                        <div class="w-full">
                                                            @if ($errors->has('pm_date_of_birth'))
                                                                <ul class="mt-1">
                                                                    @foreach ($errors->get('pm_date_of_birth') as $error)
                                                                        <li class="text-red-600 text-xs font-bold">{{ $error }}</li>
                                                                    @endforeach
                                                                </ul>
                                                            @endif
                                                ...
                                                <div class="form-group  row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="tel" name="pm_phone" class="form-control" required value="{{ old('pm_phone') }}" placeholder="+94 77 123 4567">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="border border-edu">
                                                            <textarea rows="3" class="form-control" name="pm_edu_details" placeholder="List your educational qualifications">{{ old('pm_edu_details') }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>                                                    
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="i-checks">
                                                            <label> <input {{  old('pm_account_stat') == "enable" ? "checked" : (old('pm_account_stat') =="disable" ? "" : "checked") }}
                                                                           type="radio" checked value="enable" name="pm_account_stat"> <i></i> Enable </label>
                                                        </div>
                                                        <div class="i-checks">
                                                            <label> <input {{  old('pm_account_stat') == "disable" ? "checked" : "" }}
                                                                           type="radio" value="disable" name="pm_account_stat"> <i></i> Disable </label>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('[name="pm_date_of_birth"]').datepicker({
            autoclose: true,
            format: "mm/dd/yyyy",
            keyboardNavigation: false,
            forceParse: false,
        ...
        @if(old('pm_date_of_birth'))
            $("[name='pm_date_of_birth']").datepicker("update", '{{old('pm_date_of_birth')}}');
        @endif
