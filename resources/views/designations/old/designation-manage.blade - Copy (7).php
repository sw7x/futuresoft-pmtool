    ...
    <div class="row" id="_sortable-view">
        ...
        <div class="col-lg-12 mt-3 mb-4">
            <div class="text-center">
                <button type="button" class="btn btn-lg btn-success shadow-sm" id="modal-create-main">
        ...
        <div class="col-lg-12 mt-3 mb-4">
            <div class="text-center">
                <button type="button" class="btn btn-lg btn-danger shadow-sm" id="modal-create-sub">
...
<script>
            ...
            $("#designation_jstree").jstree({
                ...
                allNodes.forEach(function(node) {
                    ...
                    if (node.data && node.data.status === false) {
                        ...
                        let nodeObj = tree.get_node(node.id);
    ...
    $(document).on("click", "#modal-desig-create-btn", function() {
        ...
        let sourceid    = $('#modal-desig-name').attr('data-source');
