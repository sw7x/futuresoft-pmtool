...
class MigrateInOrder extends Command
{
    ...
    protected $description = 'Run framework/root(Base) and all module migrations in order';
    ...
    protected array $baseLastMigrations = [
    ...
    {
        // 1. Base migrations (excluding last migrations)
        $this->runMigration('Base', 'database/migrations', $this->baseLastMigrations);
    ...
    protected function handleRollback(): int
    {
        ...
        foreach (array_reverse($this->baseLastMigrations) as $migrationPath) {
        ...
        // 3. Base last (was first to migrate)
        $this->warn('  ↩ Rolling back: Base');
    ...
    {
        foreach ($this->baseLastMigrations as $migrationPath) {
