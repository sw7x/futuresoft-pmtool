...
class ProjectManagementDbAbilities extends BaseDbAbilitiesResolver
{
    // Abilities map - keys are the "constant names" users call statically
    protected const ABILITIES = [
        'EDIT'          => '{{rolename}}_PROJECT_EDIT',
        'VIEW'          => '{{rolename}}_PROJECT_VIEW',
        'DELETE'        => '{{rolename}}_PROJECT_DELETE',
        'CREATE'        => '{{rolename}}_PROJECT_CREATE'
    ];
}
