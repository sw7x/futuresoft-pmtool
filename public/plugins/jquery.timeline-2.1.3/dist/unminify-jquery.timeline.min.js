    ...
    L = function() {
        ...
        return e = t, n = [{
            ...
            value: function(t) {
                var e = this,
                    ...
                    o = function(t, r, o, a, c, s) {
                        ...
                        l === S.colorScheme.event.border && S.colorScheme.event.border !== e._config.colorScheme.event.border && (l = e._config.colorScheme.event.border), i.strokeStyle = l, i.lineWidth = 2.5, i.filter = "url(#crisp)";
                        for (var h = 0, d = Object.keys(c.relation); h < d.length; h++) {
                            ...
                            switch (!0) {
                                ...
                                case /^(|line)size$/i.test(p):
                                    i.lineWidth = parseInt(c.relation[p], 10) || 2.5;
                                    break;
                                case /^curve$/i.test(p):
            ...
            value: function(t) {
                ...
                try{
					console.log(this._config.debug);
                }catch(err){
					console.log('err');
                }
 				...
 				console.log(this.supplement(null, t));
 				console.log('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
            ...
            value: function() {
                ...
                !1 !== e.loader && (0 == r.length && (r = r.prevObject), 0 == t.find(N.LOADER).length ? (0 == $(e.loader).length ? (s = this.is_empty(e.loadingMessage) ? "<span></span><span></span><span></span><span></span><span></span>" : e.loadingMessage, c = $("<div></div>", {
                    ...
                    width: "100%",
                    height: "100%"
                }), t.find(N.LOADER).attr("data-state", "show"))
            }
        }, {
            key: "hideLoader",
            value: function() {
