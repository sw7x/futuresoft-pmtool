@extends('core-module::layouts.master',['title' => 'Manage Tasks'])
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox">
                <div class="ibox-content">                        
                     ...
                     <div class="text-base">
                    TODO - 1. tasks that has no child then task can assign<br><br>
					2. when task has child tasks<br>
                        2.1 can assign parent task, child tasks cannot assign(manually)<br> 
                        2.2 can assign child tasks, parent task cannot assign(manually) 
                    </div><br><br> 

                    <div class="text-base">
                        TODO - when 1 task assign multiple - database\seeders\DeveloperTaskAssignmentSeeder.php comment - 4.2 - MODE B<br><br>
                    </div><br><br>
