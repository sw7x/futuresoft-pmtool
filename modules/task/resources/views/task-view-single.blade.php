@extends('core-module::layouts.master',['title' => 'View Tasks'])
                ...
                <div class="ibox-content">                        
                    ...
                    <div id="task-view-container" class="form-horizontal-details">
                        ...
                        <div class="">
                            ...
                            <div class="display-value">
                                <div class="bg-green-100 display-value-box mb-2" id="view-task-comments">
                                    USER1 - 2024-12-7 1:22PM - Initial audit completed. Waiting for server access for the production dump.
                                </div>
                                <div class="ml-5 display-value-box mb-2" id="view-task-comments">
                                    USER1 - 2024-12-7 1:22PM - Initial audit completed. Waiting for server access for the production dump.
                                </div>
                                <div class="bg-green-100 display-value-box mb-2" id="view-task-comments">
                                    USER1 - 2024-12-7 1:22PM - Initial audit completed. Waiting for server access for the production dump.
