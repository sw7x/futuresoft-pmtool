    ...
    <div class="ibox-content m-b-sm border-bottom">
        <div class="row">
            <div class="col-lg-12">                
                    ...
                    <button class="btn btn-info btn-block" id="timeline_generate">Timeline Generate</button>
                    <button class="btn btn-danger btn-block" id="timeline_destroy">Timeline Destroy</button>

                    <div class="border" id='timeline2-wrapper'>
...
let $timelineContainer  = $("#timeline2-wrapper");
let timelineId          = "#myTimeline2";
...
$(document).on('click', '#timeline_generate', function() {
    ...
    timelineWidget.Timeline('initialized', function(elm,opts,usrdata){
        ...
        $('#myTimeline2 .jqtl-side-index').find('.jqtl-side-index-item').each(function(i,el) {
            console.log($(this).html());
            txt = $(this).html();
            $(this).html('');
            $(this).append('<div class="font-semibold truncate" style="padding: 1px 5px;max-width:200px">' + txt + '</div>');
        ...
        $('#myTimeline2 .jqtl-side-index-item').css({
            //'padding'   : '1px 2px',
            'font-size' :'12px'
            // Add more properties if needed
        });
        ...
        $('#myTimeline2 .jqtl-ruler-line-item').css({'font-family': 'inherit !important'});
        $('#myTimeline2 .jqtl-event-label').css({'font-size' :'12px'});
...
/*
$(document).on('click', '#timeline2-wrapper #myTimeline2 .jqtl-event-node', function(e) {
    // Get the timeline instance
    //const instance = $('#myTimeline2').data('jq.timeline');
    const instance = $timelineContainer.find(timelineId).data('jq.timeline');
