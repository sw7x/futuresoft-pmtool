@extends('core-module::layouts.master',['title' => 'Project create'])
            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <form class="pm-create-form" id="project-create-form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Revenue</label>
                            <div class="col-sm-8">
                                <input type="number" min="0" step="0.01" name="revenue" class="form-control" value="{{ old('revenue') }}" placeholder="e.g. 45,000.00">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2" name="payment_status">
                                    ...
                                    <option {{ old('payment_status') == 'paid' ? 'selected' : '' }} value="paid">Fully Paid</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Client <span class="text-red-500 text-sm font-bold">*</span></label>
                            <div class="col-sm-8">
                                <select class="form-control select2" name="client_id" required>
                                    ...
                                    <option value="4">client Four</option>
                                    <option value="5">client Five</option>
