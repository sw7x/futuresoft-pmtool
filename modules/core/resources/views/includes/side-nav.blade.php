    ...
    <nav class="sidebar navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="{{ \Str::is(['projects.*', 'clients.*', 'invoices.*'], Route::currentRouteName()) ? 'active current' : '' }}">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded='{{ \Str::is('projects.*', Route::currentRouteName()) ? 'true' : 'false' }}'>
                        ...
                        <li class="{{ Route::is('clients.list') ? 'current' : '' }}"><a href="{{ route('clients.list') }}"><i class="fa  fa-street-view text-red"></i>Clients</a></li>
                        <li class="{{ Route::is('clients.create') ? 'current' : '' }}"><a href="{{ route('clients.create') }}"><i class="fa fa-user-plus"></i>Create client</a></li>
                        <li class="{{ Route::is('clients.single') ? 'current' : '' }}"><a href="{{ route('clients.single',3) }}"><i class="fa fa-user"></i>Single client</a></li>

                        <li class="{{ Route::is('invoices.list') ? 'current' : '' }}"><a href="{{ route('invoices.list') }}"><i class="fa fa-dollar"></i>Invoices</a></li>
                        <li class="{{ Route::is('invoices.create') ? 'current' : '' }}"><a href="{{ route('invoices.create') }}"><i class="fa fa-file-text-o"></i>Create invoice</a></li>
                        <li class="{{ Route::is('invoices.single') ? 'current' : '' }}"><a href="{{ route('invoices.single',5) }}"><i class="fa fa-file-text"></i>Single invoice</a></li>
                ...
                <li class="{{ \Str::is('tasks.*', Route::currentRouteName()) ? 'active current' : '' }}">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded='{{ \Str::is('tasks.*', Route::currentRouteName()) ? 'true' : 'false' }}'>
                        <li class="{{ Route::is('tasks.list') ? 'current' : '' }}"><a href="{{ route('tasks.list') }}"><i class="fa fa-sitemap"></i>Manage tasks</a></li>
