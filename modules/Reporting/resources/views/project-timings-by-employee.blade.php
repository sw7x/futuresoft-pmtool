@extends('core-module::layouts.master',['title' => 'Project timings by employee'])
@section('title','Project timings by employee')
...
@section('content')
    ...
    <div class="ibox-content m-b-sm border-bottom">
        <h2 class="mb-4 font-bold text-muted">Select Employee</h2>
        <div class="row">                   
