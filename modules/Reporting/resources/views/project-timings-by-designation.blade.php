@extends('core-module::layouts.master',['title' => 'Project timings by designation'])
@section('title','Project timings by designation')
...
@section('content')
    ...
    <div class="ibox-content m-b-sm border-bottom">
        <h2 class="mb-4 font-bold text-muted">Select Designation</h2>
        <div class="row">                   
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox">
                <div class="ibox-content">
                    <h2 class="mb-4 font-bold text-muted">Project ABC</h2>
