@extends('core-module::layouts.master',['title' => 'Designation timings by project'])
@section('title','Designation timings by project')
...
@section('content')
    ...
    <div class="ibox-content m-b-sm border-bottom">
        <h2 class="mb-4 font-bold text-muted">Select Designation(ajax)</h2>
        <div class="row">                   
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox">
                <div class="ibox-content">
                    <h2 class="mb-4 font-bold text-muted">Designation ABC</h2>
                    <table class="table table-bordered table-striped timesheetTable" id="wTimesheetTable">
                        <thead>
                        <tr >
                            <th class="text-center">Task ID<br/>Task Name</th>
                        ...
                        <tbody>
                            ...
                            <tr id='addr0'>
                                <td>
                                    Task{{ $i }}<br/>
                                    Employee total {{ $i % 2 !== 0 ? 'calculate' : 'draw css styles' }}...
                                </td>
                                <td>Employee {{ $i % 2 !== 0 ? '123' : '45678' }}</td>                                
