                ...
                <div class="mail-box">
                    ...
                    <div class="mail-text h-200">
                        <div class="_summernote">                            
                            <textarea rows="3" class="form-control" name="mail_compose_text">
...
<script>
    (function () {
        ...
        $('[name="mail_compose_text"]').summernote({
        ...
        @if(old('mail_compose_text'))
        $('[name="mail_compose_text"]').summernote('code', '{{old('mail_compose_text')}}');
        @endif
