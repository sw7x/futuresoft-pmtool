...
class TaskThread extends Model
{
    ...
    {
        return $this->hasMany(TaskThreadMessage::class)->orderBy('posted_date_time', 'asc');
    }
    ...
    {
        return $this->hasOne(TaskThreadMessage::class)->oldest('posted_date_time');
    }
    ...
    {
        return $this->hasOne(TaskThreadMessage::class)->latest('posted_date_time');
    }
