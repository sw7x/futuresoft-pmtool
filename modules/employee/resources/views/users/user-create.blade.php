@extends('core-module::layouts.master',['title' => 'Create Users'])
                    ...
                    <form class="pm-create-form" id="" action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if (isset($errors) && $errors->has('user_role'))
                                    <ul class="mt-1">
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if (isset($errors) && $errors->has('fname'))
                                    <ul class="mt-1">
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if (isset($errors) && $errors->has('lname'))
                                    <ul class="mt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                @if (isset($errors) && $errors->has('employment_status'))
                                    <ul class="mt-1">
